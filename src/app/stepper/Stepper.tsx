...
const steps = [
    ...
    { id: 3, title: "Contact & Timing", icon: Phone },
    ...
    const renderStepContent = () => {
        switch (currentStep) {
            ...
            case 2:
                return (
                    <Location
                        updateData={(data: LocationData) => updateOnboardingData("location", data)}
                        prevStep={prevStep}
                    />
                );
            case 3:
            ...
            case 4:
                return (
                    <Services
                        updateData={(data: ServicesData) => updateOnboardingData("services", data)}
                        prevStep={prevStep}
                    />
                );
            case 5:
